-- MolClass database data model (schema only, no data)
-- Exported from pristine model and normalized for an empty model-only deployment.
...
CREATE DATABASE IF NOT EXISTS `molclass`;
USE `molclass`;
