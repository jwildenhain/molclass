        ...
        <section className="space-y-4">
          ...
          <div className="pt-2">
            ...
            <ul className="mt-3 list-disc space-y-2 pl-5 text-muted-foreground leading-relaxed">
              ...
              <li>Fixed a worker classpath bug where CDK&rsquo;s descriptor engine was silently discovering only 51 of its 53 descriptor classes (287 of 454 features) &mdash; a partial-catalog corruption that had been producing systematically wrong feature vectors for CDK-based models. The worker&rsquo;s classpath is now generated from the same Gradle build as everything else instead of hand-globbing jars.</li>
