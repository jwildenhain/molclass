...
import { Beaker, Info, PencilRuler, Search } from "lucide-react";
      ...
      <header className="mb-8">
        <div className="flex flex-col justify-between gap-5 lg:flex-row lg:items-end">
          <div>
            ...
            <h1 className="mt-3 text-3xl font-bold tracking-tight text-foreground sm:text-5xl">Find a molecule without loading a model.</h1>
            ...
            <div className="divide-y divide-border">
              {results.map((molecule) => (
                <article
                  ...
                  className="grid gap-2 px-5 py-4 sm:grid-cols-[minmax(0,1.3fr)_100px_minmax(0,1.3fr)_minmax(0,1.6fr)] sm:items-center sm:gap-4"
                >
