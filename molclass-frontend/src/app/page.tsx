    ...
    <div className="flex flex-col items-center justify-center min-h-[70vh] space-y-12 text-center pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-6xl z-10 px-4">
        ...
        <Link href="/upload" className="group relative p-1 rounded-2xl bg-gradient-to-br from-blue-500/30 to-indigo-500/30 hover:from-blue-500/50 hover:to-indigo-500/50 transition-all duration-300 shadow-xl shadow-blue-900/20">
          <div className="bg-card/80 backdrop-blur-sm p-8 rounded-xl h-full border border-border/50 flex flex-col justify-between group-hover:bg-card/60 transition-colors">
            <div>
              ...
              <h2 className="text-2xl font-bold text-foreground mb-3">Upload SDF</h2>
              <p className="text-muted-foreground">Ingest new compound datasets directly into the unified Molclass database via drag-and-drop.</p>
            </div>
        ...
        <Link href="/model-creation" className="group relative p-1 rounded-2xl bg-gradient-to-br from-indigo-500/30 to-purple-500/30 hover:from-indigo-500/50 hover:to-purple-500/50 transition-all duration-300 shadow-xl shadow-indigo-900/20">
          <div className="bg-card/80 backdrop-blur-sm p-8 rounded-xl h-full border border-border/50 flex flex-col justify-between group-hover:bg-card/60 transition-colors">
            <div>
              ...
              <h2 className="text-2xl font-bold text-foreground mb-3">Create Models</h2>
              <p className="text-muted-foreground">Configure and queue advanced machine learning models (RandomForest, J48, etc.) against specific datasets.</p>
            </div>
        ...
        <Link href="/search" className="group relative p-1 rounded-2xl bg-gradient-to-br from-purple-500/30 to-pink-500/30 hover:from-purple-500/50 hover:to-pink-500/50 transition-all duration-300 shadow-xl shadow-purple-900/20">
          <div className="bg-card/80 backdrop-blur-sm p-8 rounded-xl h-full border border-border/50 flex flex-col justify-between group-hover:bg-card/60 transition-colors">
            <div>
              ...
              <h2 className="text-2xl font-bold text-foreground mb-3">Structure Search</h2>
              <p className="text-muted-foreground">Search the registry by identifier, InChIKey, or canonical SMILES — or draw a molecule directly. Matches exact structures only.</p>
            </div>
        ...
        <Link href="/prediction-list" className="group relative p-1 rounded-2xl bg-gradient-to-br from-emerald-500/30 to-teal-500/30 hover:from-emerald-500/50 hover:to-teal-500/50 transition-all duration-300 shadow-xl shadow-emerald-900/20">
          <div className="bg-card/80 backdrop-blur-sm p-8 rounded-xl h-full border border-border/50 flex flex-col justify-between group-hover:bg-card/60 transition-colors">
            <div>
              ...
              <h2 className="text-2xl font-bold text-foreground mb-3">Predictions</h2>
              <p className="text-muted-foreground">Select a human-approved model, find an indexed molecule, and run a prediction against it.</p>
            </div>
        ...
        <Link href="/dataset-review" className="group relative p-1 rounded-2xl bg-gradient-to-br from-cyan-500/30 to-blue-500/30 hover:from-cyan-500/50 hover:to-blue-500/50 transition-all duration-300 shadow-xl shadow-cyan-900/20">
          <div className="bg-card/80 backdrop-blur-sm p-8 rounded-xl h-full border border-border/50 flex flex-col justify-between group-hover:bg-card/60 transition-colors">
            <div>
              ...
              <h2 className="text-2xl font-bold text-foreground mb-3">Dataset Review</h2>
              <p className="text-muted-foreground">Review import outcomes, record counts, selected properties, identifiers, and model eligibility.</p>
            </div>
        ...
        <Link href="/details" className="group relative p-1 rounded-2xl bg-gradient-to-br from-amber-500/30 to-orange-500/30 hover:from-amber-500/50 hover:to-orange-500/50 transition-all duration-300 shadow-xl shadow-amber-900/20">
          <div className="absolute inset-0 bg-card/80 backdrop-blur-sm rounded-2xl"></div>
          <div className="relative p-6 flex flex-col items-center text-center space-y-4 rounded-xl h-full justify-center">
            ...
            <h2 className="text-xl font-bold text-foreground">Details & Citations</h2>
            <p className="text-sm text-muted-foreground">About MolClass, contact information, and academic citations.</p>
          </div>
        </Link>
