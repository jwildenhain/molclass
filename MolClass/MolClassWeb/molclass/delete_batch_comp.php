...
$smarty->assign( 'deleted', 'SDF file with Batch ID '.$batch_id.' and associated models, predictions have been deleted.' );

$p->addBodyContent($smarty->fetch('templates/delete_batch_comp.tpl.php'));

$cmd = "perl ".$toolsdir."delete_batch.pl ".$batch_id;
