...
if(!$a->checkAuth())
{
  ...
  $loginForm->addElement('text','username', 'email address', array('size'=>26,'maxlength'=>26,'class'=>'login_field'));
  $loginForm->addElement('password','password', 'password', array('size'=>14,'maxlength'=>14,'class'=>'login_field'));
