...
$smarty->assign( 'addresstitle', 'Contact' );
...
$smarty->assign( 'MolClassWiki', '<a href="http://tyerslab.bio.ed.ac.uk/wikiworld/sga/index.php/MolClass">MolClass Wiki</a>' );


$smarty->assign( 'downloadtitle', 'Software Download' );
$smarty->assign( 'downloadfile', $settings['root']['config']['website'].'/download/molclass_v1.08.tar.gz' );
$smarty->assign( 'downloadinfo', 'MolClass version 1.08');
$smarty->assign( 'downloadsourcecodefile', $settings['root']['config']['website'].'/download/molclass_incl_sourcecode_v1.08.tar.gz' );
$smarty->assign( 'downloadsourcecodeinfo', 'MolClass (incl. source code) version 1.08');
